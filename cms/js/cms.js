/* 
CoastCMS
Copyright (c) 2017 Fabian Meiswinkel
...
$(this).parent().after('<div class="cms_editableimage_overlay"><i class="fa fas fa-cloud-upload-alt"></i></div><input type="file" name="imgdata" class="cms_editableimage_input">');

var pathtooverlay = $(this).parent().next();

} else {

$(this).after('<div class="cms_editableimage_overlay"><i class="fa fas fa-cloud-upload-alt"></i></div><input type="file" name="imgdata" class="cms_editableimage_input">');
...
$(this).fadeTo(5, 0.8).html('<i class="fa fas fa-cloud-upload-alt"></i>');
});
...
$('.cms_editableimage_overlay').eq(index).spin(false).removeClass('dragging').html('<i class="fa fas fa-cloud-upload-alt"></i>');
...
$('body').append('<div class="cms_uploads_overlay"><div class="cms_button_add_file"><i class="fa fas fa-cloud-upload-alt"></i> Datei hochladen</div><input type="file" name="newfile" id="cms_upload_new_file" multiple><div class="cms_uploads_list"></div></div>');
