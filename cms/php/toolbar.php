...
<div class="cms_button" id="cms_button_edit" data-toggle="tooltip" title="Seite bearbeiten"><i class="fa fa-edit"></i></div>
...
<div class="cms_button" id="cms_button_duplicatefile" data-toggle="tooltip" title="Seite duplizieren"><i class="far fa-clone"></i></div>
<div class="cms_button" id="cms_button_deletefile" data-toggle="tooltip" title="Seite löschen"><i class="fas fa-trash"></i></div>
...
if ($extended_menu == 'yes') { $toolbar .= '
<div class="cms_button" id="cms_button_showsubmenu" data-toggle="tooltip" title="erweitertes Menü einblenden"><i class="fas fa-sign-out-alt fa-flip-horizontal"></i></div>
<div class="cms_button" id="cms_button_hidesubmenu" data-toggle="tooltip" title="erweitertes Menü ausblenden"><i class="fas fa-sign-out-alt"></i></div>';
}
